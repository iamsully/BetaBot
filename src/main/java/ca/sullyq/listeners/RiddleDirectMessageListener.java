...
public class RiddleDirectMessageListener extends ListenerAdapter {
    ...
    private final String guildId = HavenBot.getConfig().get("GUILD_ID");
    ...
    public void onMessageReceived(MessageReceivedEvent event) {
        ...
        Riddle activeRiddle = HavenBot.getRiddleManager().getActiveRiddle();
        ...
        String riddleAnswer = HavenBot.getRiddleManager()
            .getActiveRiddle()
            .getAnswer()
            .trim();

        if (
            HavenBot.getRiddleManager().hasMemberAnsweredRiddle(
        ...
        if (
            ...
            HavenBot.getRiddleManager().addMemberToWhoAnsweredRiddles(
                event.getAuthor().getId()
            );
